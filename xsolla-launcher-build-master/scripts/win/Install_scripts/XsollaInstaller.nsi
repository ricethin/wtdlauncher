...
!define PRODUCT_NAME "Whitethorn Digital Launcher" ;Launcher name in the Start menu. The value must be duplicated in the "product_name" parameter in the launcher/win/config.json file. 
